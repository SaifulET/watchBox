...
const envSchema = z.object({
  ...
  EBAY_RUNAME: optionalEnvString,
  EBAY_API_BASE_URL: optionalEnvUrl,
  ...
  EBAY_DEFAULT_LOCATION_CITY: z.string().default("New York"),
  EBAY_DEFAULT_LOCATION_STATE: z.string().default("NY"),
  EBAY_DEFAULT_LOCATION_POSTAL_CODE: z.string().default("10001"),
  EBAY_DEFAULT_LOCATION_COUNTRY: z.string().default("US"),
  SCRAPINGBEE_API_KEY: optionalEnvString,
  CHRONO24_BASE_URL: z.string().url().default("https://www.chrono24.com"),
  CHRONO24_COUNTRY_CODE: z.string().trim().min(2).max(2).default("us"),
  CHRONO24_RENDER_JS: envBoolean.default(true),
  ...
  AI_IMAGE_ANALYSIS_MAX_OUTPUT_TOKENS: z.coerce.number().int().positive().default(1000),
